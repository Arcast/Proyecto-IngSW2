...
{   
    ...
    public static final String USER_BIRTHDAY_TAG="birthDay";
    ...
    public static final String ERROR_USER_BIRTHDAY_TAG= "Error loading USER from XML - Error in the attribute " + USER_BIRTHDAY_TAG + " of the XML tag";
    public static final String ERROR_USER_= "Error loading USER from XML - Error in the attribute " + USER_TAG + " of the XML tag";
    ...
    public static final String USER_XML_PATH = "src/shoop/model/UserXML.xml";
    
    public static final String STORE_USER = "user";
    public static final String NICKNAME_STORE_TAG = "nickname";
