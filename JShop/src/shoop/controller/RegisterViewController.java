...
import shoop.model.UtilFunctions;
...
{
    User user1 = new User(FieldName.getText(),FieldLastName.getText(),FieldUserName.getText(),String.copyValueOf(FieldPw.getPassword()),FieldID.getText(),FieldEmail.getText(),BdayDay.getText()+"/"+BdayMonth.getText()+"/"+BdayYear.getText());
