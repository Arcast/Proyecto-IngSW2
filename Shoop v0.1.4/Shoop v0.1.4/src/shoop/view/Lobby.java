...
import shoop.controller.SearchController;
...
public class Lobby extends MyOwnJFrame{
    ...
    private void initComponents() {
        ...
        PanelResults = new javax.swing.JScrollPane();
        ...
        ButSearchProd1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ButSearchProd1MouseClicked(evt);
            }
        });
        ButSearchProd1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButSearchProd1ActionPerformed(evt);
            }
        });
        ...
        ButSearchProd.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButSearchProdActionPerformed(evt);
            }
        });
        ...
        PanelResults.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        ...
        PanelResults.setViewportView(jTextArea1);

        getContentPane().add(PanelResults, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 130, 1040, 640));
    ...
    private void ButEditUsersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButEditUsersMouseClicked
        ...
        AdminDeleteEditUserViewController.setNickname(UserConected);
        AdminDeleteEditUserViewController.loadUserinCombo();
    ...
    private void ButSearchProd1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButSearchProd1MouseClicked
        /*String a = FieldProductName.getText();
        SearchController.SearchByName(a);
        
        
        /* String b= jTextArea1.getText();
        String a = FieldProductName.getText();
        jTextArea1.setText(a+"\n\n"+b);*/
    }//GEN-LAST:event_ButSearchProd1MouseClicked

    private void ButSearchProd1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButSearchProd1ActionPerformed
       String a = FieldProductName.getText();
       // SearchController.SearchByName(a);/*
        SearchController.printProductFromDataBase(true, a);
        ...
        String a = FieldProductName.getText();
        jTextArea1.setText(a+"\n\n"+b);*/
    }//GEN-LAST:event_ButSearchProd1ActionPerformed

    private void ButSearchProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButSearchProdActionPerformed
        Object aa = CBCategory.getSelectedItem();
            String cat = String.valueOf(aa);
             System.out.println(cat);
         SearchController.printProductFromDataBase(false, cat);
        
            
            
    }//GEN-LAST:event_ButSearchProdActionPerformed
    ...
    private javax.swing.JScrollPane PanelResults;
