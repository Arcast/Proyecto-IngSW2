...
public class EditProfile extends javax.swing.JFrame {
    ...
    public EditProfile() {
        ...
        b="Zozaya";
        c="Zozi";
        d="juanzozaya06@gmail.com";
        e="20921092";
        i="password";
        f="06";
        g="04";
        h="1990";
        FieldBdayMonth.setText(g);
        FieldBdayYear.setText(h);
        FieldBdayDay.setText(f);
        FieldUsername.setText(c);
        FieldName.setText(a);
        FieldLastName.setText(b);
        FieldPW.setText(i);
        FieldRepPW.setText(i);
        FieldEmail.setText(d);
        FieldID.setText(e);
