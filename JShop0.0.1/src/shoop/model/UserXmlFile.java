...
public class UserXmlFile
{
        ...
        public static User readUserFromJDrawDataBase(String nicknameuser) throws ParseException 
    {
        ...
        Element         root,child;
        List <Element>  rootChildrens;
        String          name, firstlastName, secondLastName, nickname, email, password, id, birthdate;
        boolean         found = false;
        int             pos = 0;
        ...
        try
        {
            ...
            while (!found && pos < rootChildrens.size())
            {
                ...
                {
                    user = new User(name, firstlastName, nickname,password,id,email,birthdate);
                    found = true;
                }
                else
                {
        ...
        try
        {
            ...
            while (pos < rootChildrens.size())
            {
                ...
                if(name != null && lastName != null && nickname!= null &&
                     secondLastName !=null && email !=null && password!= null && id != null && birthDay != null)
 ...
 */
    ...
    */
       public static User readUser(String Pnickaname)
    {
        ...
        Element         root,child;
        List <Element>  rootChildrens;
        String          name, lastName, secondLastName, password,birthDay,id,email,nickname;
        boolean         Status;
        ...
        try
        {
            ...
            while (!found && pos < rootChildrens.size())
            {
                ...
                {  
                    ...
                    user = new User(name, lastName,  nickname,password , id,email, birthDay);
  ...
  public static String LogIn(String Pnickaname,String UPassword)
              ...
              public static boolean checkUserFromDataBase(String Pnickname)
    {
        ...
        Element         root,child;
        List <Element>  rootChildrens;
        String          name, lastName, secondLastName,email, password,birthDay,id,nickname,avatar;
        Date            date=new Date();
               ...
               public static User logIn(String Pnickaname,String Password)
    {
        ...
        Element         root,child;
        List <Element>  rootChildrens;
        String       name, lastName, secondLastName, password,birthDay,id,nickname,email;
        Date           date=new Date();
        boolean         Status;
