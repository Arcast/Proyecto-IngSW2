...
public static void initOutlets(JTextField FieldUsername, JTextField FieldUsername1, JPasswordField FieldPw, JPasswordField FieldPw1,String UserConected) 
{
...
{
    String Answer;
    Answer = UserXmlFile.LogIn(FieldUsername1.getText(),String.copyValueOf(FieldPw1.getPassword()));
    if (Answer.equals("TRUE"))
    {
     return true;
    }
