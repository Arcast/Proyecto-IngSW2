...
public class ProductXmlFile
{
    ...
    public static String saveProductInDataBase(Product product)
    {
        ...
        String newActualCant;
        SAXBuilder  builder = new SAXBuilder();
        if(readProductToWriteOnDataBase(product.getID(),product.getActualCant())==true) 
         {  
    ...
    public static boolean readProductToWriteOnDataBase(String ID, String newActualCant)
    {
        ...
        boolean         found = false;
        int             pos = 0;
        String          Category, Name, ImageUrl, Description, Provider,Price, MinCant,ActualCant;
        SAXBuilder      builder = new SAXBuilder();
        ...
        try
        {
            ...
            while (!found && pos < rootChildrens.size())
            {
                ...
                int xs = UtilFunctions.stringToInteger(newActualCant);
                int ys = UtilFunctions.stringToInteger(ActualCant);
                int tr = xs+ys;
                ActualCant=UtilFunctions.integerToString(tr);
                
                //UtilFunctions.integerToString(ActualCant);
                addproduct = new Product(Category, Name, "", Description, Provider,Price, "1",UProvider,ActualCant);
                ...
                if(UProvider != null && UProvider.equals(ID))
                {
                    ...
                    saveProductInDataBase(addproduct);
                    found = true;
                }
                else
                {
    ...
    public static boolean removeProductFromDataBase(String IDD)
    {
        Product            product = null ;
        Document        doc;
        Element         root,child;
        ...
        try
        {
            ...
            while (!found && pos < rootChildrens.size())
            {
                ...
                {   
                    ...
                    product= new Product(Category, Name, ImageUrl, Description, Provider,Price, MinCant,ID,ActualCant);
